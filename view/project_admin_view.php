    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <?php if ($userData['job']=='administrator'): ?>
                <label for="coordinator_id">ID del coordinador:</label>
                <input type="number" id="coordinator_id" name="coordinator_id" class="form-control" required><br>
                <?php else: ?>
                <input type="hidden" name="coordinator_id" value="<?php echo $userId; ?>">
                <?php endif; ?>
